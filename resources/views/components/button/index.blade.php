...
<button id="{{ $buttonId }}" type="button" class="focus:outline-none focus:ring-0 rounded-lg text-md-body-semibold py-2.5 px-6 flex items-center gap-2 w-auto {{ $transform . ' ' . $colorType . ' ' . $buttonClass }}">
    @if ($icon_left && $icon)
